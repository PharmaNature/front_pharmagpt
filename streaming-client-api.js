    ...
    try {
      ...
      if (firstApiResponse) {
        ...
        if (secondApiResponse.ok) {
          ...
          //console.log('Réponse de la deuxième API :', secondApiData);
        } else {
          //console.error('Erreur lors de la deuxième requête à l\'API.');
        }
      } else {
        //console.error('Erreur lors de la première requête à l\'API.');
      }
    } catch (error) {
